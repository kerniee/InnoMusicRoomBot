    ...
    public class MainBot
    {
        ...
        void Bot_OnMessage(object sender, MessageEventArgs e)
        {
            ...
            using (MobileContext db = new MobileContext())
            {
                ...
                {
                    Message mes = mainbot.SendTextMessageAsync(message.Chat.Id, "Привет. Мы пока не знакомы. Напиши @Leon_Parepko чтобы получить доступ к музкомнате.", replyToMessageId: message.MessageId).Result;
